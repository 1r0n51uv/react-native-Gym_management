...
export default class CoursesCarousel extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            fireCourse: tmp.filter(value => value.isActive)
        });
    }
                    ...
                    <Card.Content
                        ...
                        <View>
                            ...
                            >
                                ...
                                <Text
                                    style={{ fontSize: width / 25, fontFamily: 'Oswald', color: 'black', marginTop: 5 }}
                                >
                                    {' ' + item.period.endDate}
                                </Text>
                            </View>
        ...
        return (
            this.state.fireCourse.length > 0 && (
                <Carousel
                    ...
                    layout={'default'}
                    renderItem={
                        this.props.whichCarousel ? this._renderItem : this._renderItem2
                    }
